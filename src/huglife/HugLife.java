...
public class HugLife {
    ...
    public static void main(String[] args) {
    	//String worldName = "samplesolo.world";
    	//String worldName = "sampleplip.world";
    	String worldName = "strugggz.world";
    ...
    public static HugLife readWorld(String worldName) {
        //In in = new In("worlds/" + worldName + ".world");
        In in = new In(worldName);
